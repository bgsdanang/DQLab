...
names(cov_jabar_raw)
cov_jabar_raw$kasus_total # jumlah total kasus COVID-19 di Jawa Barat
cov_jabar_raw$meninggal_persen # persentase kematian akibat COVID-19 di Jawa Barat
cov_jabar_raw$sembuh_persen # persentase tingkat kesembuhan dari COVID-19 di Jawa Barat
